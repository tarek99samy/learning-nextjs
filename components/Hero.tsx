  ...
  return (
    <div className="hero">
      <div className="flex-1 pt-36 padding-x">
        ...
        <p className="hero__subtitle">Streamline your car rental experience with oure effortless booking process.</p>
      ...
      <div className="hero__image-container">
        <div className="hero__image">
          <Image src="/hero.png" alt="herom" fill className="object-contain" />
        </div>
